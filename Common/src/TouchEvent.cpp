...
tevent::Touch_State_t tevent::TouchEvent::get_state()
{
    this->is_use = true;
    return this->s;
}

bool tevent::TouchEvent::get_use() const
{
    return this->is_use;
}

uint32_t tevent::TouchEvent::get_x() const
{
    return this->last_pos.x;
}
uint32_t tevent::TouchEvent::get_y() const
{
    return this->last_pos.y;
}
